...
const ProductsList = () => {
  ...
  // const delay= { "show": 100, "hide": 100 }
  // document.getElementById('delete')?.tooltip(delay)
    ...
    products?.forEach(product => {
      ...
      data.rows.push({
        ...
        actions: <Fragment>
          ...
          <button id="delete" className="btn btn-danger py-1 px-2 ml-2" data-toggle="tooltip" data-placement="top" title="Delete" onClick={() => deleteHandler(product._id)}>
