...
const Header = (props) => {
    ...
    useEffect(() => {
        if (location.pathname === '/') {
            setButtonText('Location'); // Reset the button text when on the homepage
        }
    }, [location.pathname]);
        ...
        <Fragment>
            <nav className="navbar header">
                <div className='container'>
                    ...
                    <div className='row header-location-row' >

                        <button onClick={handleLocation} className='header-location'>
                            {/* {buttonText !=='' ? buttonText : 'Location'} */}
                            {buttonText}
